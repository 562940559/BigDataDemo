...
(function () {
	var data = {
		day365: { orders: '296,000', amount: '1,963' },
		day90: { orders: '74,000', amount: '480' },
		day30: { orders: '24,700', amount: '80' },
		day1: { orders: '608', amount: '7' }
	}
	//点击事件
...
(function () {
	var option = {
		...
		series: [{
			name: '基层',
			// 数据                                  
			data: [24, 40, 101, 134, 90, 230, 210, 210, 120, 180, 150, 70],
			// 图表类型                                  
			type: 'line',
			// 圆滑连接                                  
			smooth: true,
	...
	var data = {
		year: [
			[24, 40, 101, 134, 90, 230, 210, 210, 120, 180, 150, 70],
			[40, 64, 191, 324, 290, 330, 310, 213, 180, 200, 180, 79]
		],
		quarter: [
			[23, 25, 12, 8, 21, 15, 70, 21, 40, 52, 10, 25],
			[43, 31, 65, 23, 78, 21, 82, 64, 43, 60, 19, 34]
		],
		month: [
			[34, 40, 32, 15, 50, 12, 32, 5, 39, 36, 10, 36],
			[56, 43, 98, 21, 56, 87, 43, 12, 43, 54, 12, 98]
		],
		week: [
			[25, 30, 15, 54, 10, 40, 30, 43, 86, 43, 50, 15],
...
(function () {
				...
				data: [
					{
						...
						itemStyle: { // 颜色渐变#6acca3->#005fc1
							color: {
								...
								y2: 1,
								colorStops: [
									{ offset: 0, color: '#6acca3' },
									{ offset: 1, color: '#005fc1' }
								]
							}
						}
					},
					{ value: 100, itemStyle: { color: 'transparent' } }, // 颜色#12274d
	...
	var myechart = echarts.init($('.gauge1')[0]);
	myechart.setOption(option);
})();
(function () {
	var option = {
	...
	var myechart = echarts.init($('.gauge2')[0]);
	myechart.setOption(option);
})();
(function () {
	var data = [
		{ name: '氯化钠注射液', num: '9,086' },
		{ name: '葡萄糖注射液', num: '8,341' },
		{ name: '注射用头孢唑林钠', num: '7,407' },
		{ name: '注射用青霉素钠', num: '6,080' },
		{ name: '注射用头孢曲松钠', num: '6,724' },
		{ name: '氯化钠注射液', num: '2,170' },
	]
